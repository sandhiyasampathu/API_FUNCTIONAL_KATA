...
| 2  | Create Booking         | Missing **booking, email, phone** missing in response.                                      | ![2_create_booking_missing](src/test/resources/observations/2_create_booking_missing.png) |
...
| 12 | Delete Booking         | Missing/invalid token returns **500** instead of 401.                               | ![12_delete_booking_invalid_token](src/test/resources/observations/12_delete_booking_invalid_token_1.png) |
...
| 15 | Get Booking      | Missing **email, phone**; undocumented **bookingid**.     | ![15_get_booking_missing_fields](src/test/resources/observations/15_get_booking_missing_fields.png) |
| 16 | Get Booking      | Token invalid/missing → **403** (expected **401**).       | ![16_get_booking_invalid_token_403](src/test/resources/observations/16_get_booking_invalid_token_403.png) |
| 17 | Get Booking      | Invalid **bookingid** → **404**.                          | ![17_get_booking_invalid_id_404](src/test/resources/observations/17_get_booking_invalid_id_404.png) |
| 18 | Get Booking      | **401** only for empty/<5 char cookie; wrong error msg.   | ![18_get_booking_cookie_401_error](src/test/resources/observations/18_get_booking_cookie_401_error.png) |
